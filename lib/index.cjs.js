...
var Cache = /** @class */ (function () {
     ...
     */
    Cache.list = function () {
        for (var i = 0; i < storageReference.length; i++) {
            var key = storageReference.key(i);
            if (console && key) {
    ...
    Cache.get = function (key) {
        var value = storageReference.getItem(key);
        if (value) {
    ...
    Cache.has = function (key) {
        try {
            ...
            var tmp = storageReference.getItem(key);
...
var Staffing = /** @class */ (function () {
    ...
    Staffing.http = function () {
        var _this = this;
        var cookie = getCookie('UlEncodedIdentity');
        if (cookie && cookie.length) {
            ...
            var BhRestToken = Cache.get('BhRestToken');
...
var MetaService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(missing.length || layout)) return [3 /*break*/, 2];
                    ...
                    case 2: return [2 /*return*/, this.extract(requested)];
                }
            });
        });
    };
    ...
    MetaService.prototype.getFull = function (requested, layout) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.get(requested)];
                    case 1:
                        fields = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(!exists || !exists.hasOwnProperty('fields'))) return [3 /*break*/, 2];
                        this.parameters.layout = layout;
                    ...
                    case 2: return [2 /*return*/, this.get(exists.fields)];
                }
            });
        });
    };
    ...
    MetaService.validate = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Staffing.http().get('/meta')];
                    case 1:
                        response = _a.sent();
                        result = response.data;
                        if (result) {
                            for (_i = 0, result_1 = result; _i < result_1.length; _i++) {
                                ...
                                if (meta.dateLastModified) {
                                    item = Cache.get("meta/" + meta.entity);
...
var EntityService = /** @class */ (function () {
    ...
    EntityService.prototype.get = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.all([this.http.get(this.endpoint + "/" + id, { params: this.parameters }), this.meta.getFull(this.parameters.fields, this.parameters.layout)])];
                    case 1:
    ...
    EntityService.prototype.many = function (property, fields, value, params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.http.get(this.endpoint + "/" + value.id + "/" + property, {
...
var EntitySubscription = /** @class */ (function () {
    ...
    EntitySubscription.prototype.subscribe = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.http.put(this.endpoint, {
                            params: {
    ...
    EntitySubscription.prototype.unsubscribe = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.http.delete(this.endpoint)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
    ...
    EntitySubscription.prototype.get = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.http.get(this.endpoint, {
                            params: {
                                maxEvents: 100,
                            },
                        })];
...
var SettingService = /** @class */ (function () {
    ...
    SettingService.prototype.getSettings = function (settings) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.http.get("settings/" + settings.join())];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
    ...
    SettingService.prototype.getEntitlements = function (entity) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.http.get("entitlements/" + entity)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.data];
                }
    ...
    SettingService.prototype.getAllSettingsAndEntitlements = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.http.get('services/Settings/allEntitlementsAndSettings')];
                    case 1:
                        response = _a.sent();
                        result = response.data;
...
var Entity = /** @class */ (function (_super) {
    ...
    Entity.prototype.fields = function () {
        ...
        (_b = this.$entity).fields.apply(_b, args);
        return this;
        var _b;
    };
