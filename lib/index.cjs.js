 ...
 */
class EndlessReplaySubject extends rxjs.ReplaySubject {
    /**
...
let storageReference = new Memory();
const browserReference = new Browser();
const STORAGE_RANKINGS_KEY = 'storageRankings';
...
class Cache {
    ...
    static exceedsStorageLimit(key, value) {
    ...
    static getLocalStorageSize() {
        ...
        for (const _x of Object.keys(storageReference)) {
            ...
            const itemLength = localStorage[_x].length;
     ...
     */
    static get(key, updateRankings = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (localforage !== undefined) {
                yield localforage.ready();
                if (updateRankings) {
                    // tslint:disable-next-line:no-floating-promises
                    setTimeout(() => __awaiter(this, void 0, void 0, function* () { return Cache.handleStorageRankingUpdate(key); }), 0);
                }
    ...
    static getStorageRankings() {
        return __awaiter(this, void 0, void 0, function* () {
            const value = yield Cache.get(STORAGE_RANKINGS_KEY, false);
    ...
    static handleStorageRankingUpdate(key) {
        return __awaiter(this, void 0, void 0, function* () {
            const value = yield Cache.getStorageRankings();
...
class QueryString {
    ...
    static stringify(params) {
        const parts = QueryString.encodeParams(params);
        return parts.join('&');
    }
    /**
     * Convert to string
...
class Staffing {
    ...
    login(provider) {
        return __awaiter(this, void 0, void 0, function* () {
            return provider.credential(this.config).then((credentials) => {
                // tslint:disable-next-line:no-floating-promises
    ...
    static http(callingIdentifier = '') {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const BhRestToken = yield Cache.get('BhRestToken');
            const endpoint = yield Cache.get('restUrl');
            Staffing._http = Staffing.makeCall(callingIdentifier);
    ...
    static makeCall(callingIdentifier = '') {
        ...
        instance.interceptors.response.use((response) => {
            // Tracking
            const timing = response.config._timing || undefined;
            ...
            const timing = errorResponse.config._timing || {};
            if (Staffing.trackingCallback && timing) {
                Staffing.trackingCallback(timing.url, new Date().getTime() - timing.start);
            }
        ...
        instance.interceptors.request.use((config) => {
            ...
            config.params.uniqueCallId = uuidRandom();
    ...
    ping() {
        return __awaiter(this, void 0, void 0, function* () {
            const http = yield Staffing.http();
 ...
 */
class MetaService {
    constructor(entity, callingIdentifier = '') {
        this.entity = entity;
        this.memory = {};
        this.fields = [];
        this.layouts = [];
    ...
    initialize(callingIdentifier = '') {
        return __awaiter(this, void 0, void 0, function* () {
            this.http = yield Staffing.http(callingIdentifier);
            const meta = yield Cache.get(this.endpoint);
            if (meta) {
                this.parse(meta);
            }
            else {
    ...
    setFieldsOnLayout(meta, targetLayout) {
        if (meta && meta.layouts) {
            const foundLayoutIndex = meta.layouts.findIndex((layout) => layout.name === targetLayout);
            if (foundLayoutIndex > -1) {
                meta.layouts[foundLayoutIndex].fields = meta.fields.map((field) => field.name);
            }
    ...
    get(requested, layout) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (missing.length || layout) {
                ...
                const response = yield this.http.get(this.endpoint, { params: this.parameters });
    ...
    getAllLayouts() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.http.get(this.endpoint, { params: { meta: 'full', includeLayoutFields: true } });
            this.parse(response.data);
            return response.data.layouts;
        });
    }
    getFull(requested, layout) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.initialized;
            const fields = yield this.get(requested);
            const layoutFields = layout ? yield this.getByLayout(layout) : [];
            const full = yield Cache.get(this.endpoint);
            full.fields = [...fields, ...layoutFields];
            return full;
        });
    }
    getByLayout(layout, keepFieldsFromLayout = true) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.initialized;
            const exists = this.layouts.find((l) => l.name === layout);
            if (!exists || !exists.hasOwnProperty('fields')) {
                this.parameters.layout = layout;
                delete this.parameters.fields;
                const response = yield this.http.get(this.endpoint, { params: this.parameters });
                const result = response.data;
                const foundLayoutIndex = this.setFieldsOnLayout(result, layout);
                this.label = result.label;
    ...
    parse(result, keepFieldsFromLayout = false) {
        if (!result) {
            return;
        }
        if (result && result.fields) {
            for (const field of result.fields) {
                ...
                const exists = this.fields.find((f) => f.name === field.name);
                if (!exists) {
        ...
        if (result && result.layouts) {
            for (const layout of result.layouts) {
                const exists = this.layouts.find((l) => l.name === layout.name);
                if (!exists) {
    ...
    missing(fields) {
        ...
        for (const field of fields) {
            const cleaned = this._clean(field);
            const meta = this.memory[cleaned];
            if (!meta) {
                result.push(cleaned);
            }
        }
    ...
    static validate() {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield (yield Staffing.http()).get('/meta');
            const result = response.data;
            if (result) {
                for (const meta of result) {
                    if (meta.dateLastModified) {
                        const item = yield Cache.get(`meta/${meta.entity}`);
    ...
    static preload(entity, callingIdentifier = '') {
        return __awaiter(this, void 0, void 0, function* () {
            const meta = new MetaService(entity, callingIdentifier);
...
class EntityService {
     ...
     */
    constructor(type, callingIdentifier = '') {
    ...
    get(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.initialized;
            const [response, meta] = yield Promise.all([this.http.get(`${this.endpoint}/${id}`, { params: this.parameters }), this.meta.getFull(this.parameters.fields, this.parameters.layout)]);
            const result = response.data;
            result.meta = meta;
            return result;
        });
    ...
    edit(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const params = Object.assign({}, this.parameters, { layout });
            delete params.fields;
            const [response, meta] = yield Promise.all([this.http.get(`${this.endpoint}/${id}`, { params }), this.meta.getFull(this.parameters.fields, layout)]);
            const result = response.data;
            result.meta = meta;
            return result;
        });
     ...
     */
    many(property, fields, value, params = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.initialized;
            const toManyData = yield this.http.get(`${this.endpoint}/${value.id}/${property}`, {
                params: Object.assign({ fields, showTotalMatched: true }, params),
            });
...
class EntitySubscription {
     ...
     */
    constructor(subscriptionId, types = []) {
    ...
    subscribe() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.initialized;
            const response = yield this.http.put(this.endpoint, {
                params: {
    ...
    unsubscribe() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.initialized;
            const response = yield this.http.delete(this.endpoint);
            return response.data;
        });
    }
    /**
    ...
    get() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.initialized;
            const response = yield this.http.get(this.endpoint, {
                params: {
                    maxEvents: 100,
                },
            });
...
class Where {
     ...
     */
    static parseSearchValue(key, value) {
        const clauses = [];
        if (Array.isArray(value)) {
     ...
     * @return             part of the querystring to be returned
     */
    static parseQueryValue(key, value, isNot = false) {
        const clauses = [];
...
class QueryService {
    ...
    get total() {
        ...
        return (() => __awaiter(this, void 0, void 0, function* () {
            ...
            return this.http
                .get(this.endpoint, { params: Object.assign({ fields: 'id', count: 0 }, this.parameters) })
...
class LookupService {
    ...
    constructor(types, options = {}) {
        ...
        this.initialized = this.initialize();
        this.params(Object.assign({ entity: this.types }, this.options));
    }
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            this.http = yield Staffing.http();
...
class SettingService {
    ...
    getSettings(settings) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.initialized;
            const response = yield this.http.get(`settings/${settings.join()}`);
            return response.data;
        });
    }
    getEntitlements(entity) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.initialized;
            const response = yield this.http.get(`entitlements/${entity}`);
            return response.data;
        });
    }
    getAllSettingsAndEntitlements(cached = false) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.initialized;
            let result;
            if (cached && (yield Cache.has(this.allSettingsAndEntitlementsEndpoint))) {
                result = yield Cache.get(this.allSettingsAndEntitlementsEndpoint);
            }
            else {
                const response = yield this.http.get(this.allSettingsAndEntitlementsEndpoint);
...
class StaffingOAuthBaseProvider {
...
class StaffingCredentialsAuthProvider {
...
class StaffingOAuthProvider extends StaffingOAuthBaseProvider {
    credential(config) {
        return __awaiter(this, void 0, void 0, function* () {
            this.config = config;
            const authCode = yield this.getAuthCode();
            const tokens = yield this.validateCode(authCode);
    ...
    getAuthCode() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield axios.get(`${this.config.authorization_url}`, {
                    params: {
...
class StaffingOAuthPopupProvider extends StaffingOAuthBaseProvider {
    credential(config) {
        return __awaiter(this, void 0, void 0, function* () {
            this.config = config;
            const params = 'location=0,status=0,width=800,height=600';
                ...
                const interval = window.setInterval(() => {
                    try {
                        if (authWindow.document.URL.indexOf(this.config.redirect_url) !== -1) {
                            ...
                            const qs = QueryString.destruct(authWindow.document.URL);
 ...
 */
class StatefulSubject extends rxjs.Subject {
    constructor(_value = EMPTY$1) {
        super();
        this._value = _value;
    }
    get snapshot() {
...
// tslint:disable-next-line:only-arrow-functions
function observeOptions(options, audit$$1 = true) {
    if (!is(options).defined) {
        return rxjs.of(null);
    }
    return new rxjs.Observable((observer) => {
        let combined = rxjs.combineLatest([
        ...
        combined.subscribe(([id, fields, layout, meta, editable, readOnly, triggers, params]) => {
 ...
 * ```
 */
class Entity extends StatefulSubject {
    /**
     * constructor
     * @param  state data to inflate object with
     */
    constructor(type, options = {}, state, callingIdentifier = '') {
        super(state);
        // Fields associated with this Entity
        this._fields = [];
        this.broker = EntityMessageBroker.getInstance();
        this.type = type;
        this.$entity = new EntityService(this.type, callingIdentifier);
     ...
     */
    patch(data, ignoreEvent = false) {
        const current = this.value || {};
        const value = Object.assign({}, current, data);
        this.next(value);
        this.fields(Object.keys(value));
        if (!ignoreEvent) {
            this.broker.emit(`${this.type}:${value.id}:value`, value);
    ...
    get(id) {
        // tslint:disable-next-line:no-floating-promises
        this.$entity.get(id).then((result) => {
     ...
     * @param fields - Additional fields to retrieve on the TO_MANY field
     */
    many(property, fields) {
        // tslint:disable-next-line:no-floating-promises
        this.$entity.many(property, fields, this.value).then((response) => {
    ...
    save() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.$entity.save(this.value).then((response) => {
...
// tslint:disable-next-line:only-arrow-functions
function observeListOptions(options, audit$$1 = true) {
    if (!is(options).defined) {
        return rxjs.of(null);
    }
    return new rxjs.Observable((observer) => {
        ...
        combined.subscribe(([fields, layout, meta, orderBy, startAt, limitTo, filter$$1, params]) => {
            const serializedOptions = {};
            if (fields !== undefined) {
                serializedOptions.fields = fields;
            }
...
class EntityList extends StatefulSubject {
    constructor(type, options = {}, state, callingIdentifier = '') {
        super(state);
        this.broker = EntityMessageBroker.getInstance();
        this.type = type;
        this.$ref = new Entity(this.type, {});
    ...
    getSearcher(type, callingIdentifier = '') {
    ...
    findById(pk) {
        const found = this.getValue().find((item) => item.id === pk);
        if (found) {
            return found;
        }
    ...
    update(item, value) {
        return __awaiter(this, void 0, void 0, function* () {
            return this._checkOperationCases(item, {
                keyCase: () => __awaiter(this, void 0, void 0, function* () {
                    return this.findById(item)
                        .patch(value)
                        .save();
                }),
                entityCase: () => __awaiter(this, void 0, void 0, function* () { return item.patch(value).save(); }),
    ...
    remove(item) {
        return __awaiter(this, void 0, void 0, function* () {
            return this._checkOperationCases(item, {
                keyCase: () => __awaiter(this, void 0, void 0, function* () { return this.findById(item).remove(); }),
                entityCase: () => __awaiter(this, void 0, void 0, function* () { return item.remove(); }),
